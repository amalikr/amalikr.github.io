...
<body data-bs-theme="light">
  ...
  <nav class="navbar navbar-expand-lg navbar-light shadow sticky-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand d-flex align-items-center" href="#">
        ...
        <span class="fw-bold">Web d'Abdul</span>
      </a>
  ...
  <main class="container py-5">
    ...
    <p class="lead">Aquesta és una web amb menú desplegable, icones Font Awesome, mode clar i fosc, i disseny responsiu per mòbil i ordinador utilitzant Bootstrap 5.3.8. Aquest és el punt de partida per editar tot i fer projectes amb el professor Francesc Pérez.</p>
 <p class=lead">Sóc <u>Abdul </u> de <b>4tA ESO</b> de l'<a href="https://agora.xtec.cat/ies-pompeu-fabra-martorell/">Institut Pompeu Fabra</a>
  <p class="lead">En aquesta web veurem projectes realitzats durant 4t d'ESO a la matèria de Digitalització:
  </p>
  <ul>
    <li>Projecte 1: Comparar aliments ecològics i convencionals pel que fa al 
      nivell de nutrients: vitamines, minerals, polifenols i altres substànicies beneficoses.</li>
    <li>Projecte 2: 22 dies en 22 peus: és una cursa nàutica on aprenem a sumar vectors, 
      calcular distàncies en GPS i altres activitats</li>
  </ul>
